    ...
    <header class="py-4">
        <div class="d-flex  justify-content-center">
            <div class="col-md-9">
                <div class="card">
                    <div class="card-body">
                        <h3>{{$data? 'Ubah' : 'Tambah'}} Foto {{$data? $data->title : ''}}</h3>
                        <form method="post" action="{{ route('galeri.'.($data?'update':'store'),$data?$data->id:'') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea name="desc" rows="3" class="form-control">{{ $data? $data->desc : '' }}</textarea>
