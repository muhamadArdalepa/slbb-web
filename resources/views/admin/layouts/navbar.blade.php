<nav class="navbar navbar-expand shadow-sm {{ $class }} " style="z-index: 9;">
    <div class="container">
        ...
        <button class="nav-item btn btn-white lh-1 ms-2" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasScrolling" aria-controls="offcanvasScrolling">
