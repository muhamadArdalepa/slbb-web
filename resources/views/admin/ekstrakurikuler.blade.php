                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            ...
                            <h3>Kelola Halaman Ekstrakurikuler</h3>
                            <a href="{{ route('ekstrakurikuler.create') }}" class="btn btn-primary">Tambah data</a>
                        </div>
                                ...
                                @foreach ($data as $i => $d)
                                    <tr>
                                        ...
                                        <td class="text-center" style="white-space: nowrap">
                                            <a href="{{ route('ekstrakurikuler.edit', $d->id) }}"
                                                class="text-decoration-none p-1 text-primary">
                                                <i class="fa-solid fa-pen-to-square"></i>
                                            </a>
                                            <form class="d-inline" method="POST"
                                                action="{{ route('ekstrakurikuler.destroy', $d->id) }}">
                                                @csrf
                                                @method('DELETE')
