                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            ...
                            <a href="{{ route('tenaga-pengajar.create') }}" class="btn btn-primary">Tambah data</a>
                        </div>
                            ...
                            <tbody>
                                @foreach ($data as $i => $d)
                                    <tr>
                                        ...
                                        <td>{{ $d->name }}</td>
                                        <td>
                                            <img src="{{ asset('storage/' . $d->picture) }}" style="max-width: 5rem">
                                        </td>
                                        <td>{{ $d->nimp }}</td>
                                        ...
                                        <td class="text-center" style="white-space: nowrap">
                                            <a href="{{ route('tenaga-pengajar.edit', $d->id) }}"
                                                class="text-decoration-none p-1 text-primary">
                                                <i class="fa-solid fa-pen-to-square"></i>
                                            </a>
                                            <form class="d-inline" method="POST"
                                                action="{{ route('tenaga-pengajar.destroy', $d->id) }}">
                                                @csrf
                                                @method('DELETE')
