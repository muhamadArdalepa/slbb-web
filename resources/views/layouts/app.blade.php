...
<body>
    <div id="app" class="{{ $class ?? '' }}">
        @if (request()->is('admin*')) @include('admin.layouts.sidenav')
        ...
        @else
            @include('layouts.navbar', [
                ...
                @include('layouts.navbar', [
                    'class' => 'position-absolute top-0 z-2
                            w-100 bg-transparent navbar-dark color-white',
                ])
            @else
                @include('layouts.navbar', [
                    'class' => 'position-absolute top-0 z-2
                            w-100 bg-white navbar-light color-white',
                ])
            @endif
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="d-flex gap-3 align-items-end mb-3">
                                ...
                                <div class="h3 mb-0 lh-1">
                                    SLBB<br />Dharma Asih
                                </div>
                            </div>
                            <p style="text-align: justify">
                                SLB-B Dharma Asih Pontianak merupakan sekolah
                                yang diperuntukkan bagi anak-anak penyandang
                                tuna rungu yang berdiri pada tanggal 13 Maret
                                1972 dibawah naungan Lembaga Pendidikan SLB
